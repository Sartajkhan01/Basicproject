...
namespace Basicproject
{
    internal class Refactor
    {
        ...
        public void CompanyEmpWage(string company, int empWagePerHour, int workingDaysPerMonth, int maxHoursPerMonth)
        {
        ...
        public void CompanyEmpWage(string company, int empWagePerHr, int workingDaysPerMonth, int maxHrsPerMonth, int maxHoursPerMonth)
        {
            this.company = company;
